...
(defun ed-common-lisp/init-auto-highlight-symbol ()
  (use-package auto-highlight-symbol))

(defun ed-ed-common-lisp/post-init-auto-highlight-symbol ()
  (with-eval-after-load 'auto-highlight-symbol
    (add-to-list 'ahs-plugin-bod-modes 'lisp-mode)))

(defun ed-common-lisp/init-common-lisp-snippets ())

(defun ed-common-lisp/post-init-evil ()
...
(defun ed-common-lisp/post-init-helm ()
  (spacemacs/set-leader-keys-for-major-mode 'lisp-mode
    "sI" 'spacemacs/helm-slime))

(defun ed-common-lisp/post-init-ggtags ()
  (add-hook 'common-lisp-mode-local-vars-hook #'spacemacs/ggtags-mode-enable))

(defun ed-common-lisp/post-init-counsel-gtags ()
  (spacemacs/counsel-gtags-define-keys-for-mode 'common-lisp-mode))

(defun ed-common-lisp/post-init-helm-gtags ()
  (spacemacs/helm-gtags-define-keys-for-mode 'common-lisp-mode))

(defun ed-common-lisp/post-init-parinfer ()
  (add-hook 'lisp-mode-hook 'parinfer-mode))

(defun ed-common-lisp/init-slime-company ()
...
(defun ed-common-lisp/init-slime ()
  (use-package slime
    :commands slime-mode
    :init
    (progn
